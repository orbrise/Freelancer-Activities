...
.freelancer {
    width: calc(96% * (1/2) - 0px) !important;
	margin-left:4px;
}
.freelancer-details {
...
<!-- Content
================================================== -->
<div class="section gray padding-top-65 padding-bottom-10 full-width-carousel-fix">
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-12">
				<div class="l freelancers-container freelancers-grid-layout">
...
<!-- Category Boxes -->
<div class="section margin-top-65" style="background-color: white;">
	<div class="container">
		<div class="row">
			<div class="col-xl-12">

				<div class="section-headline centered margin-bottom-15" style="margin-top: 25px">
...
<!-- Category Boxes / End -->
<div class="alert text-center cookiealert " role="alert" id="hidethis">
    <b>Do you like cookies?</b> &#x1F36A; We use cookies to ensure you get the best experience on our website. <a href="{{url('page/privacy')}}" target="_blank">Learn more</a>
    <button type="button" id="cookieaccept" class=" button ripple-effect acceptcookies pull-right">
        I agree
    </button>
</div>
