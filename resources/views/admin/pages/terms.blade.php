...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form method="post" action="{{ route('page.termspost') }}" enctype="multipart/form-data">
                {{ csrf_field()}}
                    <div class="col-md-12">
                        <div class="form-group col-lg-12">
                        <label for="exampleInputEmail1">Terms</label>
                        <textarea id="elm1"  class="form-control" name="terms" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter address" value="{{$term->content}}">
                        </textarea>
